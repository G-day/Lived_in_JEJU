package com.example.afinal.Features.ShowStudentList;
...
import com.example.afinal.Database.DatabaseQueryClass;
import com.example.afinal.Features.CreateStudent.Student;
import com.example.afinal.Features.CreateStudent.StudentCreateDialogFragment;
import com.example.afinal.Features.CreateStudent.StudentCreateListener;
import com.example.afinal.R;
import com.example.afinal.Util.Config;
...
public class StudentListActivity extends AppCompatActivity implements StudentCreateListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studentList.addAll((Collection<? extends Student>) databaseQueryClass.getAllStudent());
